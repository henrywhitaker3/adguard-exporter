...
![Build/Push (master)](https://github.com/henrywhitaker3/adguard-exporter/workflows/Build/Push%20(master)/badge.svg)
[![GoDoc](https://godoc.org/github.com/henrywhitaker3/adguard-exporter?status.png)](https://godoc.org/github.com/henrywhitaker3/adguard-exporter)
[![GoReportCard](https://goreportcard.com/badge/github.com/henrywhitaker3/adguard-exporter)](https://goreportcard.com/report/github.com/henrywhitaker3/adguard-exporter)
...
* Architecture **i386** [
    [Linux](https://github.com/henrywhitaker3/adguard-exporter/releases/latest/download/pihole_exporter-linux-386) /
    [Windows](https://github.com/henrywhitaker3/adguard-exporter/releases/latest/download/pihole_exporter-windows-386.exe)
]
* Architecture **amd64** [
    [Darwin](https://github.com/henrywhitaker3/adguard-exporter/releases/latest/download/pihole_exporter-darwin-amd64) /
    [Linux](https://github.com/henrywhitaker3/adguard-exporter/releases/latest/download/pihole_exporter-linux-amd64) /
    [Windows](https://github.com/henrywhitaker3/adguard-exporter/releases/latest/download/pihole_exporter-windows-amd64.exe)
]
* Architecture **arm** [
    [Darwin](https://github.com/henrywhitaker3/adguard-exporter/releases/latest/download/pihole_exporter-darwin-arm64) /
    [Linux](https://github.com/henrywhitaker3/adguard-exporter/releases/latest/download/pihole_exporter-linux-arm)
]
...
# or
$ git clone https://github.com/henrywhitaker3/adguard-exporter.git
```
